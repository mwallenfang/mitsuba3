...
class BundleIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    MI_IMPORT_BASE(MonteCarloIntegrator, m_max_depth, m_rr_depth, m_hide_emitters)
    MI_IMPORT_TYPES(Scene, Sampler, Medium, Emitter, EmitterPtr, BSDF, BSDFPtr)

    BundleIntegrator(const Properties &props) : Base(props) { }
    ...
    std::pair<Spectrum, Bool> sample(const Scene *scene,
        ...
        dr::Loop<Bool> loop("Bundle Tracer", sampler, ray, throughput, result,
    ...
    std::string to_string() const override {
        return tfm::format("BundleIntegrator[\n"
            "  max_depth = %u,\n"
            "  rr_depth = %u\n"
...
MI_IMPLEMENT_CLASS_VARIANT(BundleIntegrator, MonteCarloIntegrator)
MI_EXPORT_PLUGIN(BundleIntegrator, "Bundle Tracer integrator");
